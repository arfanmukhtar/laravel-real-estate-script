                ...
                <div class="col-lg-8">
                    <div class="ibox float-e-margins">
                        ...
                        {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Custom Fields</label>
                                    <div class="col-sm-10">
                                        <select class="form-control select2" multiple id="custom_fields" name="custom_fields[]">
                                            <option value="area">Area Size</option>
                                            <option value="bed-bath">Bed/Bath</option>
                                            <option value="build_year">Build Year</option>
                                            <option value="no_of_story">Number of Story</option>
