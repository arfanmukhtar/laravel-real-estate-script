                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form id="postAnAd"  method="POST" class="form-horizontal form-post-ads" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-sm-2 col-form-label">{{trans('Select Purpose') }}</label>
                                        <div class="col-sm-8">
                                            <label class="form-check form-check-inline col-form-label">
                                                <label class="form-check-label mb-0 pb-0">
                                                    <input class="form-check-input" type="radio" checked name="ad_type" id="inlineRadio1" value="sell">{{trans('Sell') }}
                                                </label>
                                            </label>
                                            <label class="form-check form-check-inline col-form-label">
                                                <label class="form-check-label mb-0 pb-0">
                                                    <input class="form-check-input" type="radio"  name="ad_type" id="inlineRadio2" value="rent">{{trans('Rent') }}
                                                </label>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <label class="form-check form-check-inline col-form-label">
                                                <label class="form-check-label mb-0 pb-0">
                                                    <input class="form-check-input" type="radio"  name="condition" id="inlineRadio1" value="new">{{trans('ads.post_ad.new') }}
                                                </label>
                                            </label>
                                            <label class="form-check form-check-inline col-form-label">
                                                <label class="form-check-label mb-0 pb-0">
                                                    <input class="form-check-input" type="radio" checked name="condition" id="inlineRadio2" value="used">{{trans('ads.post_ad.used') }}
                                                </label>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label  class="col-sm-2 col-form-label">{{trans('Full Address') }}</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="address" id="address" placeholder="">
                                            <small id="" class="form-text text-muted">
                                                <b>Example:</b> H# 1, Street 6, London
                                            </small>
                                        </div>
                                    </div>
