                                            ...
                                            <div class="col-md-12 no-padding photobox is-featured">
                                                ...
                                                <div class="add-desc-box">
                                                    ...
                                                    <div class="ads-details">
                                                        ...
                                                        @endif
                                                        <div> </b> {{$catName}} </b>&nbsp;&nbsp; &nbsp;&nbsp;<i class="fa fa-bed"></i> &nbsp; {{$post->post_detail->bedrooms ?? 'N/A'}} &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<i class="fa fa-bath"></i> &nbsp; {{$post->post_detail->bathrooms ?? 'N/A'}} &nbsp;&nbsp;&nbsp;&nbsp; {{$post->post_detail->area_size . " " . $post->post_detail->area_size_type  ?? 'N/A'}} </div>
